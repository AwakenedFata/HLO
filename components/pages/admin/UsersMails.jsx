    ...
    <div className="adminpanelmanajemenusersmails">
      ...
      <Card className="shadow-sm">
        <Card.Header className="bg-light">
          <span className="fw-bold">Daftar User Mails</span>
        </Card.Header>
        <Card.Body>
          <Row className="mb-3">
            <Col md={8}>
              ...
              <DropdownButton
                ...
                title={
                  <>
                    ...
                    {filterStatus === "unread" && "Belum Dibaca"}
                    {filterStatus === "read" && "Sudah Dibaca"}
                ...
                disabled={loading || !dataLoaded}
              >
                <Dropdown.Item active={filterStatus === "unread"} onClick={() => handleFilterChange("unread")}>
                  Belum Dibaca
                </Dropdown.Item>
                <Dropdown.Item active={filterStatus === "read"} onClick={() => handleFilterChange("read")}>
                  Sudah Dibaca
                </Dropdown.Item>
                <Dropdown.Item active={filterStatus === "archived"} onClick={() => handleFilterChange("archived")}>
                  Archived
                </Dropdown.Item>
                <Dropdown.Item active={filterStatus === "all"} onClick={() => handleFilterChange("all")}>
                  Semua
                </Dropdown.Item>
              </DropdownButton>
            </Col>
      ...
      <Modal show={showDeleteModal} onHide={() => setShowDeleteModal(false)} centered>
        ...
        <Modal.Body>
          <p>
            Apakah Anda yakin ingin menghapus mail dari <strong>{mailToDelete?.name}</strong>?
          </p>
        ...
        <Modal.Footer>
          ...
          <Button variant="danger" onClick={handleDeleteMail} disabled={deleting}>
            {deleting ? (
              <>
                <Spinner animation="border" size="sm" className="me-2" />
                Menghapus...
