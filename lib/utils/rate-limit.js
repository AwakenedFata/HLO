...
export function rateLimit({ interval, uniqueTokenPerInterval = 500, limit, identifier = "global" }) {
  ...
  // Skip unref() in edge runtime environments
  // Node.js specific code that ensures cleanup interval doesn't keep the process running
  if (
